...
cd %projectPath%
echo ^> javac -cp .;* %relativePath%%fileName%
javac -cp .;* %relativePath%%fileName% 2> %tempFile%
...
echo ^> java -cp .;* org.junit.runner.JUnitCore %compiledClassPath%%fileBaseName%
java -cp .;* org.junit.runner.JUnitCore %compiledClassPath%%fileBaseName%
